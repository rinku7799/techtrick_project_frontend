...
const MagwheelChairModel = ({ show, handleClose }) => {
    ...
    <>
      <Modal show={show} onHide={handleModalClose}>
        ...
        <Modal.Body>
          <Row>
            <Col lg={12}>
              <div className="row border rounded-2 p-1 mx-0 lightgray-bg-color">
                <div className="col-6">
                  <input
                    type="text"
                    className="border-0 w-100 lightgray-bg-color"
          ...
          {!isVerified && (
            <Modal.Footer className="border-0 p-0 mt-3">
              <Button variant="primary" onClick={handleVerify} className="w-100">
                Verify
              </Button>
            </Modal.Footer>
          )}
...
export default MagwheelChairModel;
