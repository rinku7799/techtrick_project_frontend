    ...
    const nursingServices = [
        {
            ...
            name: "Shree Hari Pathology Laboratory",
        ...
        {
            image: nursingservice3,
            name: "Aishni Pathology Laboratory",
            address: "525/E, Vyapari Peth, E Ward, Shahupuri, Kolhapur, Maharashtra -695320"
        },
        {
            image: homeattend1,
    ...
    return (
        <>
         <div style={{ backgroundColor: '#F9F9F9' }}>
                <Breadcrumb breadcrumbTitle="Lab Partners"
                    breadcrumbNav={[
                        {
                            navText: "Home",
                            path: "/",
                ...
                <div className='pt-5 '>
                    <div className='fw-bold fs-5'>40+ Lab center</div>
                    <div className='p-3 mt-2' style={{ backgroundColor: "#EDEDED" }}>
                        ...
                        <Row>
                            {filters.map((filter, index) => (
                                <Col lg={6} md={6} className="service" key={index} style={{ borderLeft: filter.label === 'Select Services' ? '2px solid #BCBCBC' : 'none' }}>
                                    <Dropdown className="rounded-2 d-flex justify-content-between align-items-center" style={{ backgroundColor: "white" }}>
                                        ...
                                        <Dropdown.Menu className="w-100 p-3">
                                            ...
                                            <Row className="mt-2">
                                                <Col>
                                                    <Button className="btn border w-100 lightgray-bg-color text-dark" >Clear All</Button>
                                                </Col>
                                                <Col>
                                ...
                                <Card className="w-100 border rounded-2" style={{ height: '18.9rem', margin: '0px 0px' }}>
                                    ...
                                    <Card.Body >
                                        ...
                                        <Link to="/pathlab/labpartners/labcenterdetail">
                                            <Button variant="light" className="btn w-100 border-black">View</Button>
                                        </Link>
                                    </Card.Body>
                                </Card>
                            </Col>
